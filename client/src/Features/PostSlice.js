...
export const savePost = createAsyncThunk("posts/savePost", async (postData) => {
    try {
      const response = await axios.post(`https://myapp-server-qmdr.onrender.com/savePost`, {
  ...
  export const getPosts = createAsyncThunk("post/getPosts", async () => {
    try {
      const response = await axios.get(`https://myapp-server-qmdr.onrender.com/getPosts`);
